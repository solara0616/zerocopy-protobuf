...
static constexpr uint64_t PROTO_USER_HEADER_SIZE{120};
using ProtoUserHeader = ZeroedBuffer<char, PROTO_USER_HEADER_SIZE>;
...
struct ChunkHeader
{
    ...
    uint64_t actualUserPayloadSize() const noexcept;
    ...
    UserPayloadOffset_t UserPayloadOffset() const noexcept {
      return m_userPayloadOffset;
    }
